...
const Cursor = () => {
  ...
  /**@ts-ignore */
  const innerRef = React.useRef<HTMLDivElement>(0);
  /**@ts-ignore */
  const outerRef = React.useRef<HTMLDivElement>(0);
  ...
  const toggleCursorSize = () => {
    if (cursorEnlarged.current) {
      ...
      outerRef.current.style.backgroundColor = "#c007a1";
      ...
      outerRef.current.style.border = "1px solid #c007a1";
    }
  };
