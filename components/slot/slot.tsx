...
export default function Slot() {
  ...
  const getApproveAmount = async () => {
    ...
    const allowance = await tokenContractProvider!.allowance(
      address,
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="flex justify-center">
                    <div>
                      ...
                      <h1 className="text-white font-bold text-right h-[30px]">{wager > 0 ? (wager * 100).toFixed(2) : '-'}</h1>
                      <h1 className="text-white font-bold text-right h-[30px]">{wager > 0 ? (wager * 45).toFixed(2) : '-'}</h1>
                      <h1 className="text-white font-bold text-right h-[30px]">{wager > 0 ? (wager * 20).toFixed(2) : '-'}</h1>
                      <h1 className="text-white font-bold text-right h-[30px]">{wager > 0 ? (wager * 12).toFixed(2) : '-'}</h1>
                      <h1 className="text-white font-bold text-right h-[30px]">{wager > 0 ? (wager * 10).toFixed(2) : '-'}</h1>
                      <h1 className="text-white font-bold text-right h-[30px]">{wager > 0 ? (wager * 5).toFixed(2) : '-'}</h1>
                      <h1 className="text-white font-bold text-right h-[30px]">{wager > 0 ? (wager * 3).toFixed(2) : '-'}</h1>
                      <h1 className="text-white font-bold text-right h-[30px]">{wager > 0 ? (wager * 2).toFixed(2) : '-'}</h1>
                    </div>
                  </div>
                </div>
              </div>
